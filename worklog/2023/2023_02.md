...
- 飛達體育
  - Fix scroll position error and deploy
- 神經衰弱
  - Refactor compare logic, dataflow
  - Add card flip style
  - Add reset logic
...
- 飛達體育
  - Baseball
    - Fix StarPlayer
      - Context empty
      - Disable Player name switch line
      - Fix context
  - Footer
    - Adjust mobile text size
  - Football
    - 修正蒙沙主場圖片與名稱
    - 修正佛倫提那球場名稱
  - Basketball
    - Fix Northwest Division Context
  - CommonPlay
    - Football Context
  - Router
    - Fix star player redirection
- 打磚塊
  - Fix brick render bug
  ...
  - Adjust style
    ...
    - Basketball
      ...
      - Navbar
        - Menu
          - Add hover
          - Add open and close status display on icon
- 打磚塊
  - Fix Brick render bug
